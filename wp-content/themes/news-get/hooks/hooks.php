...
if (!function_exists('newsget_front_page_banner_section')) :
    /**
     *
     * @since Newsway
     *
     */
    function newsget_front_page_banner_section()
    {
...
add_action('newsget_action_front_page_main_section_1', 'newsget_front_page_banner_section', 40);