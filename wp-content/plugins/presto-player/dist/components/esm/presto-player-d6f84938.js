import { a as _slicedToArray, d as _objectSpread2$1, e as _defineProperty$2, f as _createClass$1, i as _typeof, j as _classCallCheck$1, _ as _toConsumableArray, k as _objectWithoutProperties, l as _asyncToGenerator, m as _createForOfIteratorHelper, r as registerInstance, c as createEvent, h, H as Host, g as getElement$1 } from './index-65cf7490.js';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return import('./resize-observer-05e5e763.js');
...
function PrestoPlayer$1 (element) {
  ...
  if (typeof learndash_video_data !== 'undefined') {
    import('./learndash-b6b8d73b.js').then(function (module) {
  ...
  if (typeof _tutorobject !== 'undefined') {
    import('./tutor-7fc74ae5.js').then(function (module) {
...
const createPlayer = (function (_ref) {
  ...
  if (src && isHLS(src)) {
    return import('./hls-1bc0f44d.js').then(function (module) {
  ...
  return new Promise(function (resolve) {
    var player = new PrestoPlayer$1(selector, _objectSpread2$1({}, config));
...
const PrestoPlayer = class {
  ...
  async syncVideoHeight() {
    ...
    if ('ResizeObserver' in window === false) {
      const module = await import('./resize-observer-05e5e763.js');
      window.ResizeObserver = module.ResizeObserver;
    }
...
export { PrestoPlayer$1 as P, PrestoPlayer as a, resumeProgress as r };
