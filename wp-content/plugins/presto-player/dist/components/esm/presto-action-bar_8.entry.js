import { r as registerInstance, h, g as getElement, c as createEvent } from './index-65cf7490.js';
...
const PrestoDynamicOverlays = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.reloadComponent = createEvent(this, "reloadComponent", 7);
    this.watermarkRef = {
      left: null,
      right: null,
    };
  ...
  render() {
    ...
    return (h("div", { class: "overlays", ref: el => (this.container = el) }, h("div", { class: "top-left", ref: el => (this.topLeft = el) }, !!this.shouldShowWatermark('top-left') && (h("presto-dynamic-overlay-ui", { ref: el => (this.watermarkRef.left = el), style: {
      ...
      })), h("div", { class: "top-right", ref: el => (this.topRight = el) }, !!this.shouldShowWatermark('top-right') && (h("presto-dynamic-overlay-ui", { ref: el => (this.watermarkRef.right = el), style: {
...
const PrestoYoutube = class {
  ...
  render() {
    ...
    if (this.lazyLoad) {
      return (h("div", null, h("presto-video", { part: "video", getRef: this.getRef, poster: this.poster, src: "", provider: "youtube" }), h("div", { class: "presto-player__play-cover", onClick: () => this.loadPlayer() })));
    }
...
export { PrestoActionBar as presto_action_bar, PrestoBunny as presto_bunny, PrestoCTAOverlay as presto_cta_overlay, PrestoDynamicOverlays as presto_dynamic_overlays, PrestoEmailOverlay as presto_email_overlay, PrestoMutedOverlay as presto_muted_overlay, PrestoVimeo as presto_vimeo, PrestoYoutube as presto_youtube };
