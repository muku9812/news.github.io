...
const EmailOverlayUI = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return (index.h("div", { class: `overlay ${this.direction === 'rtl' ? 'rtl' : ''}`, ref: el => (this.textInput = el) }, index.h("div", { class: "content" }, index.h("h1", null, this.headline || ((_a = this === null || this === void 0 ? void 0 : this.i18n) === null || _a === void 0 ? void 0 : _a.emailDefaultHeadline)), this.isLoading ? (index.h("presto-player-spinner", null)) : (index.h("form", { onSubmit: e => this.handleSubmit(e) }, index.h("input", { type: "email", placeholder: (_b = this === null || this === void 0 ? void 0 : this.i18n) === null || _b === void 0 ? void 0 : _b.emailPlaceholder, value: this.email, onInput: event => this.handleChange(event), required: true }), index.h("button", { type: "submit" }, this.buttonText || ((_c = this === null || this === void 0 ? void 0 : this.i18n) === null || _c === void 0 ? void 0 : _c.play)))), this.errorMessage && index.h("p", { class: "error" }, this.errorMessage), this.bottomText && index.h("p", { innerHTML: this.bottomText }), !!this.allowSkip && (index.h("div", { class: "skip", onClick: () => {
        this.skip.emit();
...
exports.presto_email_overlay_ui = EmailOverlayUI;
exports.presto_player_spinner = PrestoSpinner;
