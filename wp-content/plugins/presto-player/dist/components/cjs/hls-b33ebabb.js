...
const prestoPlayer_entry = require('./presto-player-75916563.js');
          ...
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              hls.on(window.Hls.Events.MANIFEST_PARSED, function (event, data) {
                ...
                var player = new prestoPlayer_entry.PrestoPlayer(selector, index._objectSpread2({}, config));
            ...
            case 14:
              return _context.abrupt("return", resolve(new prestoPlayer_entry.PrestoPlayer(selector, index._objectSpread2({}, config))));
